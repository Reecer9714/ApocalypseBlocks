...
package net.mcreator.apocalypseblocks.gui;
...
import net.mcreator.apocalypseblocks.ApocalypseBlocks;
...
public class GuiBunkerExpansionGUI extends ElementsApocalypseBlocks.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiBunkerExpansionGUI(ElementsApocalypseBlocks instance) {
		super(instance, 33);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 17, 12) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 35, 12) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 53, 12) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 71, 12) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 89, 12) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 107, 12) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 125, 12) {
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 143, 12) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				ApocalypseBlocks.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("apocalypseblocks:textures/bunkerexpansiongui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 7, this.guiTop + 56, 60, 20, "Select"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 115, this.guiTop + 56, 50, 20, "Build"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			ApocalypseBlocks.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
